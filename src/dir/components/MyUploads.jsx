...
function MyUploads() {
  return (
<div className='mt-12   font-medium rounded-xl  bg-pink-400 text-gray-800   '>

<div class="overflow-x-auto">
        <div class="min-w-screen min-h-screen bg-gray-100 flex items-center justify-center bg-gray-100 rounded-xl  font-sans overflow-hidden">
